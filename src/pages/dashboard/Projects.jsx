...
const Projects = () => {
  ...
  const handleCreate = async (e) => {
    ...
    const newProject = {
      ...
      images: ["https://images.unsplash.com/photo-1545324418-cc1a3fa10c00"], // Placeholder
    ...
    loadProjects();
    setFormData({ name: '', address: '', status: 'active', priceMin: '', priceMax: '' });
  };
          ...
          <table className="w-full text-left">
            ...
            <tbody className="divide-y divide-gray-200 dark:divide-gray-700">
              {loading ? (
                ...
                <tr key={project.id} className="hover:bg-white/5 transition-colors border-b border-white/5 last:border-0">
