  ...
  return (
    <div ref={containerRef} className="fixed inset-0 -z-10 overflow-hidden bg-background transition-colors duration-500">
      <div className="absolute inset-0 opacity-40 filter blur-[80px]">
        <div 
          ref={blob1Ref}
          className="absolute top-1/4 left-1/4 w-96 h-96 bg-primary/10 dark:bg-primary/20 rounded-full mix-blend-multiply dark:mix-blend-screen"
        />
        <div 
          ref={blob2Ref}
          className="absolute top-3/4 right-1/4 w-[500px] h-[500px] bg-accent/10 dark:bg-accent/20 rounded-full mix-blend-multiply dark:mix-blend-screen"
        />
        <div 
          ref={blob3Ref}
          className="absolute bottom-1/4 left-1/2 w-80 h-80 bg-section/30 dark:bg-primary/10 rounded-full mix-blend-multiply dark:mix-blend-screen"
        />
      </div>
